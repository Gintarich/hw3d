...
char Keyboard::CharIsEmpty() const noexcept
{
...
void Keyboard::OnKeyPressed(unsigned char keycode) noexcept
{
	...
	m_keybuffer.push(Event{ Keyboard::Event::Type::Press,keycode });
...
void Keyboard::OnKeyReleased(unsigned char keycode) noexcept
{
	...
	m_keybuffer.push(Event(Keyboard::Event::Type::Release, keycode));
	TrimBuffer(m_keybuffer);
}
